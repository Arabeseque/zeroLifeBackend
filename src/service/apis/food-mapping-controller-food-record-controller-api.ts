...
/**
 * FoodMappingControllerFoodRecordControllerApi - axios parameter creator
 * @export
 */
export const FoodMappingControllerFoodRecordControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 根据id批量删除自定义食物计划表
...
/**
 * FoodMappingControllerFoodRecordControllerApi - functional programming interface
 * @export
 */
export const FoodMappingControllerFoodRecordControllerApiFp = function(configuration?: Configuration) {
    return {
        /**
         * 根据id批量删除自定义食物计划表
         * @summary 根据id批量删除自定义食物计划表
        ...
        async foodRecordDelete(foodRecordVoIds: Array<string>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Result>> {
            const localVarAxiosArgs = await FoodMappingControllerFoodRecordControllerApiAxiosParamCreator(configuration).foodRecordDelete(foodRecordVoIds, options);
        ...
        async foodRecordGet(page: number, num: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FormResult>> {
            const localVarAxiosArgs = await FoodMappingControllerFoodRecordControllerApiAxiosParamCreator(configuration).foodRecordGet(page, num, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async foodRecordPageNumGet(page: string, num: string, name: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FormResult>> {
            const localVarAxiosArgs = await FoodMappingControllerFoodRecordControllerApiAxiosParamCreator(configuration).foodRecordPageNumGet(page, num, name, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async foodRecordPost(foodRecordVo?: FoodRecordVo, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Result>> {
            const localVarAxiosArgs = await FoodMappingControllerFoodRecordControllerApiAxiosParamCreator(configuration).foodRecordPost(foodRecordVo, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async foodRecordPut(foodRecordVo?: FoodRecordVo, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Result>> {
            const localVarAxiosArgs = await FoodMappingControllerFoodRecordControllerApiAxiosParamCreator(configuration).foodRecordPut(foodRecordVo, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
/**
 * FoodMappingControllerFoodRecordControllerApi - factory interface
 * @export
 */
export const FoodMappingControllerFoodRecordControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        /**
         * 根据id批量删除自定义食物计划表
         * @summary 根据id批量删除自定义食物计划表
        ...
        foodRecordDelete(foodRecordVoIds: Array<string>, options?: any): AxiosPromise<Result> {
            return FoodMappingControllerFoodRecordControllerApiFp(configuration).foodRecordDelete(foodRecordVoIds, options).then((request) => request(axios, basePath));
        },
        /**
         * 分页查询所有食物记录
         * @summary 分页查询所有食物记录
        ...
        foodRecordGet(page: number, num: number, options?: any): AxiosPromise<FormResult> {
            return FoodMappingControllerFoodRecordControllerApiFp(configuration).foodRecordGet(page, num, options).then((request) => request(axios, basePath));
        },
        /**
         * 根据用户名称模糊分页查询所有食物记录表
         * @summary 根据用户名称模糊分页查询所有食物记录表
        ...
        foodRecordPageNumGet(page: string, num: string, name: string, options?: any): AxiosPromise<FormResult> {
            return FoodMappingControllerFoodRecordControllerApiFp(configuration).foodRecordPageNumGet(page, num, name, options).then((request) => request(axios, basePath));
        },
        /**
         * 增加食物记录表(id需要为null)
         * @summary 增加食物记录表(id需要为null)
        ...
        foodRecordPost(foodRecordVo?: FoodRecordVo, options?: any): AxiosPromise<Result> {
            return FoodMappingControllerFoodRecordControllerApiFp(configuration).foodRecordPost(foodRecordVo, options).then((request) => request(axios, basePath));
        },
        /**
         * 修改自定义食物计划表
         * @summary 修改自定义食物计划表
        ...
        foodRecordPut(foodRecordVo?: FoodRecordVo, options?: any): AxiosPromise<Result> {
            return FoodMappingControllerFoodRecordControllerApiFp(configuration).foodRecordPut(foodRecordVo, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * FoodMappingControllerFoodRecordControllerApi - object-oriented interface
 * @export
 * @class FoodMappingControllerFoodRecordControllerApi
 * @extends {BaseAPI}
 */
export class FoodMappingControllerFoodRecordControllerApi extends BaseAPI {
    /**
     * 根据id批量删除自定义食物计划表
     * @summary 根据id批量删除自定义食物计划表
     * @param {Array<string>} foodRecordVoIds 
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof FoodMappingControllerFoodRecordControllerApi
     */
    public foodRecordDelete(foodRecordVoIds: Array<string>, options?: any) {
        return FoodMappingControllerFoodRecordControllerApiFp(this.configuration).foodRecordDelete(foodRecordVoIds, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public foodRecordGet(page: number, num: number, options?: any) {
        return FoodMappingControllerFoodRecordControllerApiFp(this.configuration).foodRecordGet(page, num, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public foodRecordPageNumGet(page: string, num: string, name: string, options?: any) {
        return FoodMappingControllerFoodRecordControllerApiFp(this.configuration).foodRecordPageNumGet(page, num, name, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public foodRecordPost(foodRecordVo?: FoodRecordVo, options?: any) {
        return FoodMappingControllerFoodRecordControllerApiFp(this.configuration).foodRecordPost(foodRecordVo, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public foodRecordPut(foodRecordVo?: FoodRecordVo, options?: any) {
        return FoodMappingControllerFoodRecordControllerApiFp(this.configuration).foodRecordPut(foodRecordVo, options).then((request) => request(this.axios, this.basePath));
    }
